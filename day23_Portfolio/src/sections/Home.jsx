...
const Home = () => {
  return (
    <div className="flex items-center justify-center">
      <div
        className="h-[500px] w-[1000px] border border-white/50 text-white rounded-2xl mt-60 mb-10 flex flex-col items-center justify-center bg-cover bg-no-repeat"
        // style={{ backgroundImage: `url(${heroImg})` }}
      >
        <span className="py-2 px-4 bg-none border border-white rounded-full text-sm">
          ✔Available for work
        </span>
